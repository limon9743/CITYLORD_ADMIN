...
import "./ArrangeViewingFormPotentialTenants.css";
...
const ArrangeViewingFormPotentialTenants = () => {
  const { id } = useParams();
  ...
  const onSubmit = (data) => {
    const ViewInfo = {
      ...
      arrangedfor: data.arrangedfor,
    };
    axios.post("https://api.clwapping.co.uk/api/view/addviewing", ViewInfo);
  };
...
export default ArrangeViewingFormPotentialTenants;
