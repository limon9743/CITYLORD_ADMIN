...
import "./ContractorFormForEdit.css";

const ContractorFormForEdit = () => {
  const { register, handleSubmit, errors } = useForm();
  const onSubmit = (data) => {
    console.log(data);
    axios
      .post("https://api.clwapping.co.uk/api/contractor/newcontractor", data)
      .then((res) => {
        console.log(res);
      })
      .catch((err) => {
...
export default ContractorFormForEdit;
