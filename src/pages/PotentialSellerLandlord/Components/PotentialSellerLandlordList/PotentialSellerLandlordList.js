...
import "./PotentialSellerLandlordList.css";

const PotentialSellerLandlordList = () => {
  ...
  return (
    <div className="all-properties-to-rent-div">
      <div className="title-and-property-add-button-div">
        <h1>List of Potential Seller Landlords</h1>
...
export default PotentialSellerLandlordList;
